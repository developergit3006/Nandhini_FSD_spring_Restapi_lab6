package com.greatlearning.ssrsm.security.web;
...
import com.greatlearning.ssrsm.security.service.SsrsmUserDetailsServiceImpl;

@Configuration
public class SsrsmSecurityConfiguration {
	@Bean
	public UserDetailsService userDetailsService() {
		return new SsrsmUserDetailsServiceImpl();
	}
